...
{% include figure popup=true image_path="/assets/images/2017-04-03-address-decoding.png" alt="AMX AXC 68000 address decoding" caption="AMX AXC 68000 address decoding" %}
...
{% include figure popup=true image_path="/assets/images/2017-04-03-axlink_bus.png" alt="AXLink bus schematic" caption="AXLink bus schematic" %}
