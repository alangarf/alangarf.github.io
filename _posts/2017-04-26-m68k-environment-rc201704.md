...
thumbnail: "/assets/images/2017-04-18/mc68340.jpg"
...
{% include image date="2017-04-18" file="axc-em.jpg" alt="AMX AXC-EM" class="center" %}
...
{% include image file="mc68340.png" alt="The internals of the MC68340" %}

The SIM40 modules can move the addresses of these devices where ever you
choose, but the layout is:

{% include image file="sim40.png" alt="The SIM40 address structure" %}
...
data and running it: {% include image file="hello_world.gif" alt="GIF showing
the boot-loader in action" no_tmb="true" %}
